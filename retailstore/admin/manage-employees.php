...
$query -> execute();
$_SESSION['delmsg']="Employee deleted scuccessfully ";
...
<head>
    ...
    <title>Retail Store Management System | Manage Categories</title>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                          ...
                                          <a href="edit-employee.php?empid=<?php echo htmlentities($result->id);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
